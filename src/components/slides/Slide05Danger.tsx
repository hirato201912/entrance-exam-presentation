...
export default function Slide05Danger({ onNext }: SlideProps) {
  ...
  return (
    <div 
      className="min-h-screen bg-gradient-to-br from-gray-900 via-red-900 to-black flex items-center justify-center p-4"
    ...
    >
      ...
      >
        <motion.div 
          className="relative bg-gradient-to-r from-red-700 via-red-800 to-red-900 text-white p-4 md:p-6"
          ...
          <div className="relative z-10">
            <div className="text-center">
              ...
              >
                ...
                <span className="text-white/80 text-sm md:text-base font-medium">今までのやり方のままだと危険</span>
                <div className="w-1.5 h-1.5 bg-white/60 rounded-full animate-pulse" />
              </motion.div>
            </div>
          </div>
        ...
        <div className="p-3 md:p-4 lg:p-6">
          <AnimatePresence>
            {currentStep === 0 && (
              ...
              >
                <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold bg-gradient-to-r from-red-600 to-red-700 bg-clip-text text-transparent leading-tight mb-4">
                  対策なしでは
                </h2>
                <motion.h2 
                  className="text-2xl md:text-3xl lg:text-4xl font-bold bg-gradient-to-r from-red-700 to-red-900 bg-clip-text text-transparent mb-4"
                ...
                >
                  <motion.div
                    ...
                    className="bg-red-100 border-2 border-red-400 rounded-full p-2 inline-flex"
                  >
          ...
          <AnimatePresence>
            {currentStep === steps.length && (
              ...
              >
                <motion.div 
                  className="relative bg-gradient-to-r from-red-50 via-red-100 to-red-50 border-2 border-red-300 rounded-2xl p-4 md:p-6 shadow-xl"
                ...
                >
                  ...
                  <div className="text-center pt-4">
                    ...
                    >
                      対策を知らないと
                      <span className="bg-gradient-to-r from-red-600 to-red-800 bg-clip-text text-transparent mx-2">
                        苦戦する
                      </span>
                    </motion.h3>
                    ...
                    >
                      対策を知っている子との差は<strong className="text-red-600">どんどん広がって</strong>いく
                    </motion.p>
                  </div>
                </motion.div>
              </motion.div>
        ...
        >
          <div className="flex justify-center items-center">
            {currentStep < steps.length && (
              <motion.button
                onClick={nextStep}
                className="group bg-gradient-to-r from-red-600 via-red-700 to-red-800 hover:from-red-700 hover:via-red-800 hover:to-red-900 text-white px-6 py-3 rounded-xl font-bold text-base shadow-xl hover:shadow-2xl transition-all duration-300 flex items-center space-x-2"
