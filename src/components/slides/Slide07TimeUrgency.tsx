...
export default function Slide07TimeUrgency({ onNext }: SlideProps) {
  const [currentStep, setCurrentStep] = useState(0)
  const [timeLeft, setTimeLeft] = useState({ months: 0, text: '' })
  ...
  useEffect(() => {
    const calculateTimeLeft = () => {
      ...
      const examDate = new Date(examYear, 1, 15)
      
      const monthsLeft = (examDate.getFullYear() - now.getFullYear()) * 12 + 
      ...
      if (monthsLeft <= 0) {
        ...
        timeText = `あと${monthsLeft}ヶ月`
      }
      
      setTimeLeft({ months: monthsLeft, text: timeText })
    }
  ...
  return (
    <div 
      className="min-h-screen bg-gradient-to-br from-slate-900 via-orange-900 to-yellow-900 flex items-center justify-center p-4"
    ...
    >
      ...
      >
        <motion.div 
          className="relative bg-gradient-to-r from-orange-600 via-yellow-600 to-orange-700 text-white p-4 md:p-6"
        ...
        <div className="p-3 md:p-4 lg:p-6">
          <AnimatePresence>
            {currentStep === 0 && (
              ...
              >
                <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold bg-gradient-to-r from-orange-500 to-yellow-500 bg-clip-text text-transparent leading-tight mb-4">
                  時間は待ってくれない！
                </h2>
                ...
                <motion.div
                  ...
                  className="inline-flex items-center bg-gradient-to-r from-orange-100 to-yellow-100 border-2 border-orange-300 rounded-2xl px-6 py-3 shadow-lg"
                >
          ...
          <AnimatePresence>
            {currentStep === steps.length && (
              ...
              >
                <motion.div 
                  className="relative bg-gradient-to-r from-red-50 via-orange-50 to-yellow-50 border-2 border-orange-300 rounded-2xl p-4 md:p-6 shadow-xl"
                ...
                >
                  ...
                  >
                    <div className="bg-orange-500 rounded-full p-2 shadow-lg border-2 border-white">
                  ...
                  <div className="text-center pt-4">
                    ...
                    >
                      3年分の復習 + 新形式対応 =
                      <span className="bg-gradient-to-r from-orange-500 to-red-500 bg-clip-text text-transparent mx-2">
                        膨大な量
                      </span>
                    </motion.h3>
                    ...
                    >
                      これらすべてを<strong className="text-orange-600">{timeLeft.text}</strong>でやる必要がある。<br className="hidden md:block" />
                      <strong className="text-red-600">一人でやるには、もう時間が足りない</strong>
                    </motion.p>
                  </div>
                </motion.div>
              </motion.div>
        ...
        >
          <div className="flex justify-center items-center">
            {currentStep < steps.length && (
              <motion.button
                onClick={nextStep}
                className="group bg-gradient-to-r from-orange-500 via-yellow-500 to-orange-600 hover:from-orange-600 hover:via-yellow-600 hover:to-orange-700 text-white px-6 py-3 rounded-xl font-bold text-base shadow-xl hover:shadow-2xl transition-all duration-300 flex items-center space-x-2"
